...
import AnimList from "@/components/AnimListToBeDeleted";
...
const Column = ({ title, headingColor, cards, column, setCards }) => {
  ...
  const [cardss, setCardss] = useState(DEFAULT_CARDS);
  ...
  return (
    <div className="w-56 shrink-0">
      ...
      <div onDrop={handleDrop} onDragOver={handleDragOver} className={`h-full w-full transition-colors `}>
        {filteredCards.map((crd) => {
          return <Card key={crd.id} {...crd} handleDragStart={handleDragStart} />;
        })}
